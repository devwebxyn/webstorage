...
type ToastOptions = Omit<ToastState, 'id' | 'open' | 'onOpenChange'> & {
  title?: string
  description?: string
  action?: ToastActionElement
  variant?: 'default' | 'destructive'
...
function toast({ ...props }: ToastOptions): { id: string; dismiss: () => void; update: (props: Partial<ToastOptions>) => void } {
  const id = genId()
...
export type { ToastActionElement, ToastState }
export {
  ToastProvider,
  ToastViewport,
